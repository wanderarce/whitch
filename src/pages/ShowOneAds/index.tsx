...
import pointsImg from "../../assets/adsIcones/iconepontos.png";
...
const ShowOneAds: React.FC = () => {
    ...
    const loadAds = async () => {
        ...
        const adsAsString = await AsyncStorage.getItem('showAds');
        const adsShow = await JSON.parse(adsAsString);
        setAds([adsShow]);
    ...
    const isLikedAds = (id) => {
        const likedAds = profile.liked_ads ?? [];
        return likedAds.includes(id);
    }
