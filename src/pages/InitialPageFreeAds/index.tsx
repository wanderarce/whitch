...
const InitialPageFreeAds: React.FC = () => {
    ...
    const makeSearch = async () => {
        ...
        const adsByGroup = groupIds.length > 0
            ? await searchFreeAds(term)
            : [];

        setFreeAds(adsByGroup);
        ...
        <>
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{width: window.width * 0.333, height: 40}}
                          onTouchEnd={() => navigation.navigate('InitialPageGroup')}
                    >
                        <View>
...
export default InitialPageFreeAds;
