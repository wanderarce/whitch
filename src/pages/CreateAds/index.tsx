            ...
            try {
                ...
                await api.post('/ads', data, config)
                    ...
                    .catch((error) => {
                        ...
                        let message = getMessageByAxiosError(error, 'Não foi possível realizar o cadastro, por favor tente novamente!')
                ...
                <Container>
                    ...
                    >
                        ...
                        <Text style={{
                            ...
                            *Imagem melhor visualizado com resolução 880px x 340px, tamanho máximo para upload 1MB por
                            arquivo
                        </Text>
