...
const AdsByGroup: React.FC = () => {
    ...
    const loadGroupInfo = async () => {
        ...
        if (group === null) {
            Alert.alert('Ocorreu um erro!', 'Não conseguimos buscar informações do grupo.')
            return null;
        }
    ...
    const loadAds = async () => {
        ...
        if (groupId == null) {
            Alert.alert('Ops, erro!', 'Não conseguimos encontrar dados grupo.')
            return;
        }
        ...
        if (ads === null) {
            Alert.alert('Ops, erro!', 'Não conseguimos buscar os anúncios do grupo.')
            return;
        }
