...
import AdsSelect from "../../components/InputAds";
import AsyncStorage from "@react-native-community/async-storage";

const window = Dimensions.get('window');

const CreditPoint: React.FC = () => {
    ...
    const handlerCredit = useCallback(
        async (data) => {
            try {
                ...
                await api.post('/user-points/credit', data, config)
                    .then((response) => {
        ...
        <>
            ...
            <KeyboardAwareScrollView style={{flex: 1, backgroundColor: "#FFF"}}>
                ...
                <ContainerForm>
                    ...
                    <Form ref={formRef} onSubmit={handlerCredit}>
