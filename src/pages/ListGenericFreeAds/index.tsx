...
const ListGenericFreeAds: React.FC = () => {
    ...
    const loadAds = async () => {
        setLoading(true);
        const title = await AsyncStorage.getItem('listGenericFreeAdsTitle');
        const ads = await AsyncStorage.getItem('listGenericFreeAds');
...
export default ListGenericFreeAds;
